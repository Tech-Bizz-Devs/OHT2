<%@ Page Title="MyOrders - mfpower.in " Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MyOrder.aspx.cs" Inherits="MyOrder" %>
                                ...
                                <div class="row">
                                    <div class="col-xs-8 col-lg-8">
                                      ...
                                      <div class="col-xs-4 col-lg-4">
                                             <a href="myaccount.aspx" class="theme-btn-1 btn btn-effect-1" style="border:solid 2px #17a9fc;margin-top:5px">Back</a>
                                      </div>
                                </div>
                                <div class="row">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="LblOrderId" runat="server" Text='<%#Eval("OrderId") %>'></asp:Label>
                                                                         <asp:Label ID="lblShippingMobileNo" runat="server" Visible="false" Text='<%#Eval("ShippingMobileNo") %>'></asp:Label>
                                                                           <asp:Label ID="ShippingEmailId" runat="server" Visible="false" Text='<%#Eval("ShippingEmailId") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <%#Eval("RTS")%>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:LinkButton ID="LnkViews" runat="server" Font-Bold="true" CommandName="View" Style="color:black">Order Detail</asp:LinkButton>
                                                                    </td>
                                                                     <td>
                                                                        <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="true" CommandName="cen" Style="color:red">Cancel</asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:ListView>
                                                                    ...
                                                                    <table width="200px" cellpadding="0" cellspacing="0" border="0" style="margin-left: 576px; margin-top: -194px; padding-top: 9px;">
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding-left: 110px;" colspan="2" rowspan="8">
                                                                                ...
                                                                                <%--  <a style="text-decoration: none" href="http://digitalmobiz.com" target="_blank">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <tr style="background-color: white; color: #535353; border-bottom: 1px solid #e2e2e2;" align="center" valign="top" class="spaceUnder">
                                                                    ...
                                                                    <td style="text-align: left;" valign="top" class="LstMyCart_td">
                                                                        ...
                                                                        <br />
                                                                        <asp:Label ID="Label9" runat="server" CssClass="pdCode1" ForeColor="#000" Text='<%# Eval("size") %>'></asp:Label>
