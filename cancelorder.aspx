<%@ Page Title="Cancel Order - mfpower.in " Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="cancelorder.aspx.cs" Inherits="cancelorder" %>
                                ...
                                <div class="row">
                                    <div class="col-xs-8 col-lg-8">
                                        <div class="heading-part heading-bg mb-30">
                                            <h2 class="heading m-0"><i class="fa fa-clock-o" aria-hidden="true"></i>Cancel Orders</h2>
                                        </div>
                                    </div>
