...
PreparedStatement ps=null;
    ...
    try{
        ...
        String sql ="SELECT i.emp_no ,i.ename, a.username,i.type, a.date, a.action FROM audit_table AS a JOIN info AS i ON a.username = i.username;";
    ...
    try {
        ...
        String sql = "SELECT * FROM audit_table WHERE s_no LIKE ?";
        ps = conn.prepareStatement(sql);
        ps.setString(1, "%" + searchText + "%"); // Use % as a wildcard to match any characters before and after the search text
        rs = ps.executeQuery();
        tbl_3.setModel(DbUtils.resultSetToTableModel(rs));
    } catch (Exception e) {
        JOptionPane.showMessageDialog(null, e);
