...
public partial class familykit : System.Web.UI.Page
{
    ClsConnection cnn = new ClsConnection();
    public static string productname = "", productid = "3", pid="3",image = "", Description = "", img2 = "", img3 = "", img4 = "", img5 = "", img6 = "";
    public static Int32 price = 0, discount=0,netprice=0;
    protected void Page_Load(object sender, EventArgs e)
    {
        cnn.Open();
        DataTable dtlsrblog = cnn.FillTable("select * from [product] where productid=3", "Detail");
      ...
      //  var img55 = "<meta property=\"og:image\" content=\"https://www.mfpower.in/img/product/" + img5 + "\"  style=\"height:600px;width:600px\"/>";
        ...
        string url = "https://www.mfpower.in/familykit.aspx";


        Page.Title = productname + "- mfpower.in";
        Page.MetaKeywords = "Feel like young again in first application,It Helps you to Increase your Stamina,It Helps you to Improve your Vitality,It helps you to increase Endurance,It helps to Increase Testosterone levels,It helps to Increase Energy Level,Desire to Improve your performance";
        Page.MetaDescription = "family kit is a complete combo pack for both male & female . It gives you the Energy to face your self with the reality. When the nature let's you down , family kit helps you to fight by with all the personal problems which are facing in your day to day life.";
